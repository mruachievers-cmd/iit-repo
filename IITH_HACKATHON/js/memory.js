...
class MemorySystem {
    ...
    setPlayerEmail(email) {
        this.getMemory('receptionist').playerEmail = email;
        this.save();
    }

    getPlayerEmail() {
        return this.getMemory('receptionist').playerEmail;
    }

    setOtpVerified() {
        this.flags.otpVerified = true;
        this.save();
    }
    ...
    clearAll() {
        this.memories = {};
        this.flags = { gdScore: 0, roundsPassed: 0, bossesDefeated: 0, hasJob: false, roundFailed: false, hasKeycard: false, otpVerified: false };
